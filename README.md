...
This extension has been tested with [FantasyGrounds Classic](https://www.fantasygrounds.com/home/FantasyGroundsClassic.php) 3.3.12 and [FantasyGrounds Unity](https://www.fantasygrounds.com/home/FantasyGroundsUnity.php) 4.0.0 (2020-1-04). If you are running it with Classic, you will need to use [my customised version of ClockAdjuster](https://github.com/bmos/FG-PFRPG-Disease-Tracker/releases/tag/v2.2).
